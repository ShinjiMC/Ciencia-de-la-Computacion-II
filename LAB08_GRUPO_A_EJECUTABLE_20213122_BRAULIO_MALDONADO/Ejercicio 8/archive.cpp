...
#include "Header.h" 
using namespace std;
forma::forma(string a, double b2, double b, string c) {
	color = a;
	x = b2;
	y = b;
	nombre = c;
...
elipse::elipse(string a, double b2, double b, string c, double d, double e) :forma(a, b2, b, c) {
	RadioM = d;
	Radiome = e;
}
...
double elipse::areas() {
	double pi1 = 3.14159265358979323846;
	double area = pi1 * (RadioM * Radiome);
	return area;
}
circulo::circulo(string a, double b2, double b, string c, double d, double e) :elipse(a, b2, b, c,d,e) {}
...
double circulo::areas() {
	double area = elipse::areas();
	return area;
}

rectangulo::rectangulo(string a, double b2, double b, string c, double d, double e) :forma(a, b2, b, c) {
	l_menor = d;
	l_mayor = e;
}
...
double rectangulo::areas() {
	double area = l_mayor * l_menor;
	return area;
}
...
cuadrado::cuadrado(string a, double b2, double b, string c, double d, double e) :rectangulo(a, b2, b, c, d, e) {}
...
double cuadrado::areas() {
	double area = rectangulo::areas();
	return area;
}
